...
from get_dataset import Custom_Dataset

def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('--raf_path', type=str, default='D:/datasets/rafdb_basic', help='Raf-DB dataset path.')
...
def run_training():
    ...
    train_dataset = Custom_Dataset(root='D:/FERexperiments/datasets/FERPlus', phase='train', basic_aug=False, transform=data_transforms) 
    ...
    data_transforms_val = transforms.Compose([
        ...
        transforms.Normalize(mean=[0.485, 0.456, 0.406],
                                 std=[0.229, 0.224, 0.225])])                                           
    val_dataset = Custom_Dataset(root='D:/FERexperiments/datasets/FERPlus', phase='test', basic_aug=False, transform=data_transforms_val)
