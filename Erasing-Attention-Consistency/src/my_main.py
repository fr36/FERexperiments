...
root_dir = Path(__file__).parent.parent.parent  # 根据 my_train.py 的位置调整
sys.path.append(str(root_dir))
print(str(root_dir))

from datasets.customdataset import CustomImageFolder

parser = argparse.ArgumentParser()
parser.add_argument('--resnet50_path', type=str, default='D:/FERexperiments/Erasing-Attention-Consistency/model/resnet50_ft_weight.pkl', help='pretrained_backbone_path')
...
def main():    
    ...
    train_dataset = CustomImageFolder(root='D:/FERexperiments/datasets/AffectNet', phase='train', transform=train_transforms)
    test_dataset = CustomImageFolder(root='D:/FERexperiments/datasets/AffectNet', phase='test', transform=eval_transforms)
    ...
    for i in range(1, args.epochs + 1):
        ...
        print(f'Epoch {i}: Test Accuracy = {test_acc:.4f}')
        if test_acc > best_test_acc:
            ...
            if epochs_no_improve >= patience:
                ...
                break
        with open('AffectNet_EAC' + '.txt', 'a') as f:
